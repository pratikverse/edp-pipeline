...
Usage:
    ...
    python scripts/train_yolo.py --data data/synth_mixed/data.yaml --name symbol_detector_mixed
    python scripts/train_yolo.py --device cpu   # force CPU even if a GPU is available

Both data/synth* and outputs/yolo_runs/* (besides the currently-shipped
symbol_detector_mixed/ weights) are gitignored and fully regenerated by
this script + generate_synthetic_dataset.py/generate_ladder_circuits.py —
not kept around between work sessions.
"""
